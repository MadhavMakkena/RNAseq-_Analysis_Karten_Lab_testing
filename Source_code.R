...
#
par(mfrow=c(2,3))
plotCounts(DESeq, gene="NPC1", intgroup="condition")
plotCounts(DESeq, gene="NPC2", intgroup="condition")
plotCounts(DESeq, gene="ABCA1", intgroup="condition")
plotCounts(DESeq, gene="STARD3", intgroup="condition")
plotCounts(DESeq, gene="STARD4", intgroup="condition")
plotCounts(DESeq, gene="ACTB", intgroup="condition")
