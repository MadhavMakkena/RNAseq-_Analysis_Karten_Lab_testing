...
plotCounts(DESeq, gene="NPC1", intgroup="condition", transform=F, ylim=c(0, 4000))
plotCounts(DESeq, gene="NPC2", intgroup="condition", transform=F, ylim=c(0, 4000))
plotCounts(DESeq, gene="STARD3", intgroup="condition", transform=F, ylim=c(0, 4000))
plotCounts(DESeq, gene="STARD4", intgroup="condition", transform=F, ylim=c(0, 4000))
plotCounts(DESeq, gene="VDAC", intgroup="condition", transform=F, ylim=c(0, 4000))
...
#                          title="FFibroblast vs. SH-SY5Y",
#                          p=0.005, #adjusted p-value threshold for DEGs
#                          FC=log2(2), #log2FoldChange threshold for DEGs (can be 0)
