...
volcanoPlota<-function(res, title, p=NULL, pval=NULL, FC=1, lab=NULL, col=NULL, cola=NULL, fclim=NULL, showNum=TRUE, returnDEG=F, expScale=F, upcol=NULL, dncol=NULL){
